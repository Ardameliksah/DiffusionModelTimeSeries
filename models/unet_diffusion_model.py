...
#----------------------------------------------------------------------------
# Wrapper class for compatibility with training scripts

@persistence.persistent_class
class UNetDiffusionModel(torch.nn.Module):
    """
    Wrapper for U-Net diffusion models that provides a unified interface.
    Works with SongUNet or other architectures from this file.
    """
    ...
    def __init__(self,
        ...
        **kwargs
        ...
        """
        Args:
            img_resolution: Image resolution (e.g., 8, 16, 32)
            in_channels: Number of input channels
            out_channels: Number of output channels
            model_channels: Base number of channels
            channel_mult: Channel multipliers per resolution
        ...
        # Use SongUNet as the underlying model
        self.unet = SongUNet(
        ...
        self.in_channels = in_channels
        self.out_channels = out_channels
        self.num_timesteps = 1000  # Default number of diffusion timesteps
    ...
    def forward(self, x, t, class_labels=None, augment_labels=None):
        ...
        """
        return self.unet(x, t, class_labels, augment_labels)
    
    def compute_loss(self, x_0: torch.Tensor, loss_type: str = "mse") -> torch.Tensor:
        """
        Compute diffusion loss for image-based model.
        ...
        # Simple linear noise schedule: sigma_t = t / num_timesteps
        sigma_t = (t.float() / self.num_timesteps).reshape(-1, 1, 1, 1).to(dtype)
        
        # Add noise: x_t = x_0 + sigma_t * noise
        x_t = x_0 + sigma_t * noise
        
        # Predict noise via U-Net
